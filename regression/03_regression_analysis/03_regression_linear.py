#!/usr/bin/env python3
# ==============================================================================
# SCRIPT:  03_regression_linear.py
...
od_files = sorted(glob.glob(os.path.join(od_dir, "OD_linear_*.parquet")))
sd_files = sorted(glob.glob(os.path.join(sd_dir, "SD_*_linear_*.parquet")))
